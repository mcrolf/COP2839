...
namespace CarDealershipApp.Migrations
{
    ...
    [Migration("20231204185859_dec042023")]
    partial class dec042023
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarDealershipApp.Areas.Admin.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("CarDealershipApp.Areas.Admin.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EmployeeID = 1,
                            FirstName = "Silent",
                            HireDate = new DateTime(2023, 12, 4, 0, 0, 0, 0, DateTimeKind.Local),
                            LastName = "Bob",
                            Position = "Sales",
                            Salary = 45000m
                        });
            ...
            modelBuilder.Entity("CarDealershipApp.Areas.Admin.Models.Customer", b =>
                {
                    b.HasOne("CarDealershipApp.Models.User", "User")
                        .WithMany()
